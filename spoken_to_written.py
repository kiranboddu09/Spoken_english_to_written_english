...
class SpokenToWritten:
    ...
    def get_user_input(self):
        ...
        self.paragraph=input("\n[IN]:Enter Your paragraph of spoken english which has to be converted into written english:\n\t")
        ...
        while i<no_of_words: 
            ...
            #when word is of the form e.g.: two 
                ...
                if word.lower() in numbers.keys() and (next_word.lower()=='dollars' or next_word.lower()=='dollar'):
                    ...
                    i=i+2
                elif word.lower() in numbers.keys() and (next_word.lower()=='percentage' or next_word.lower()=='percentage'):
                    self.ouptut_para=self.ouptut_para+" "+front+"%"+str(numbers[word.lower()])+last
                    i=i+2
...
#main function 
def conversion_of_spoken_to_written():
    #creating class object
    obj_spoken=SpokenToWritten()
    obj_spoken.get_user_input()
    obj_spoken.Conversion()
